      ...
      <div className="flex gap-2 flex-wrap w-full">
        {(["all", "draft", "confirmed", "received"] as const).map((status) => (
          <Button
            ...
            className={`capitalize w-full sm:w-auto ${filterStatus === status ? "bg-accent text-accent-foreground" : "border-2"}`}
          >
            {status}
          </Button>
        ))}
            ...
            <table className="min-w-[600px] w-full text-xs md:text-sm">
              <thead>
                <tr className="border-b-2 border-border">
                  <th className="text-left py-2 px-2 md:py-3 md:px-4 font-semibold text-foreground">Receipt #</th>
                  <th className="text-left py-2 px-2 md:py-3 md:px-4 font-semibold text-foreground">Supplier</th>
                  <th className="text-left py-2 px-2 md:py-3 md:px-4 font-semibold text-foreground">Date</th>
                  <th className="text-center py-2 px-2 md:py-3 md:px-4 font-semibold text-foreground">Items</th>
                  <th className="text-right py-2 px-2 md:py-3 md:px-4 font-semibold text-foreground">Total</th>
                  <th className="text-center py-2 px-2 md:py-3 md:px-4 font-semibold text-foreground">Status</th>
                  <th className="text-center py-2 px-2 md:py-3 md:px-4 font-semibold text-foreground">Actions</th>
                </tr>
              </thead>
              <tbody>
                {filteredReceipts.map((receipt) => (
                  <tr key={receipt.id} className="border-b border-border hover:bg-secondary/50 transition-colors">
                    <td className="py-2 px-2 md:py-3 md:px-4 text-foreground font-medium">{receipt.receiptNumber}</td>
                    <td className="py-2 px-2 md:py-3 md:px-4 text-muted-foreground">{receipt.supplier}</td>
                    <td className="py-2 px-2 md:py-3 md:px-4 text-muted-foreground">{receipt.date}</td>
                    <td className="py-2 px-2 md:py-3 md:px-4 text-center font-semibold">{receipt.items}</td>
                    <td className="py-2 px-2 md:py-3 md:px-4 text-right text-foreground font-semibold">${receipt.total.toFixed(2)}</td>
